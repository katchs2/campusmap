...
LabeledMarker.prototype.initialize = function(map) {
  ...
  // Jie, 2008-04-29, this controls the color of the text
  this.div_.innerHTML = '<strong><FONT size=1 COLOR="black" style="background-color:yellow;filter:alpha(opacity=60);-moz-opacity:.60;opacity:.60">'+this.labelText_+'</FONT></strong>';
